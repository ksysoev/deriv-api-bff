...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/etcd v0.34.0 // indirect
...
replace github.com/coreos/bbolt => go.etcd.io/bbolt v1.3.11 // required for etcd compatibility

replace google.golang.org/grpc => google.golang.org/grpc v1.26.0 // required for etcd compatibility
