...
func (_m *MockDerivAPI) Handle(_a0 *Conn, _a1 *Request) error {
...
func (_c *MockDerivAPI_Handle_Call) Run(run func(_a0 *Conn, _a1 *Request)) *MockDerivAPI_Handle_Call {
...
func (_c *MockDerivAPI_Handle_Call) RunAndReturn(run func(*Conn, *Request) error) *MockDerivAPI_Handle_Call {
	_c.Call.Return(run)
	return _c
}
