...
func (_m *MockDerivAPI) Handle(_a0 *Conn, _a1 *request.Request) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*Conn, *request.Request) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *MockDerivAPI_Handle_Call) Run(run func(_a0 *Conn, _a1 *request.Request)) *MockDerivAPI_Handle_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*Conn), args[1].(*request.Request))
	})
	return _c
}
...
func (_c *MockDerivAPI_Handle_Call) RunAndReturn(run func(*Conn, *request.Request) error) *MockDerivAPI_Handle_Call {
	_c.Call.Return(run)
	return _c
}
